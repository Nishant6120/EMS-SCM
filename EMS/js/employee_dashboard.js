(function($) {
    ...
    function handleUpdateAllocatedTask(e) {
        ...
        const completedDateStr = elements.modalTaskCompletedDate.val();
        if (task.status === 'Completed' && completedDateStr) {
            task.taskCompletedDate = formatDateToISO(completedDateStr);
        } else {
